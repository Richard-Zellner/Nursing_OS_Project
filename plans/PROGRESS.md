...
| P3 | Dysphagia Screen FHIR | M3 done: CQL library compiled to ELM, all 15 fixtures pass | review | Owner: P3-Q019 gating, M2-4 wording, CQL review, Q020–Q022. Agent next: M4 HAPI on the portable JDK and `$apply` (Wave C1) | Mar 2027 |
| P4 | Grounded Handoff | M1 built except HAPI loading; fact sheet, value-fidelity verifier (layer 2) and omission check built | in-progress | Owner: Q021–Q031, inventory and verifier-doc review. Agent next: P4-M3-4 citation view, M5-4 Provenance; HAPI loading follows P3's Java HAPI route; generation needs a model decision | Apr – mid-May 2027 |
